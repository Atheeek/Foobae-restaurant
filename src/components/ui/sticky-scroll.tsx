  ...
  return (
    <ReactLenis root>
      <main className="bg-black" ref={ref}>
        ...
        <section className="text-white p-1 w-full bg-slate-950">
          <div className="grid grid-cols-12 gap-1">
            {/* Left column */}
            <div className="grid gap-1 col-span-4">
              <figure className="w-full">
                <img
                  src="https://plus.unsplash.com/premium_photo-1669742928112-19364a33b530?q=80&w=687&auto=format&fit=crop"
                  alt="Indian restaurant interior"
                  className="transition-all duration-300 w-full h-60 sm:h-52 md:h-72 lg:h-96 object-cover rounded-md"
                />
              </figure>
              <figure className="w-full">
                <img
              ...
              <figure className="w-full">
                <img
                  src="https://plus.unsplash.com/premium_photo-1694141252774-c937d97641da?q=80&w=688&auto=format&fit=crop"
                  alt="Butter chicken"
                  className="transition-all duration-300 w-full h-60 sm:h-52 md:h-72 lg:h-96 object-cover rounded-md"
                />
              </figure>
            ...
            <div className="sticky top-0 h-screen w-full col-span-4 gap-1 grid grid-rows-3">
            ...
            <div className="grid gap-1 col-span-4">
              <figure className="w-full">
                <img
                  src="https://images.unsplash.com/photo-1696265350630-efa107c33990?q=80&w=687&auto=format&fit=crop"
                  alt="Masala dosa"
                  className="transition-all duration-300 w-full h-60 sm:h-52 md:h-72 lg:h-96 object-cover rounded-md"
                />
              </figure>
